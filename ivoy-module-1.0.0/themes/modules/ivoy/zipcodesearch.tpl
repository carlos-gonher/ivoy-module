...
<html lang="es-mx">
    ...
    <body>
        ...
        function initMap(lat, long) {
            ...
            var coordinates = {lat: parseFloat(lat), lng: parseFloat(long)};
            ...
            google.maps.event.addListener(autocomplete, 'place_changed', function() {
              ...
              //console.log('event.addListener - place_changed: ' + JSON.stringify(place, null, 2));
            ...
            function setValues(lat, lng){
                parent.document.getElementById("search-lat").value = lat;
                parent.document.getElementById("search-lng").value = lng;
            }
